 ...
 *
 */
if ( ! class_exists('VCS_CS_REST_Templates') ) :
class VCS_CS_REST_Templates extends VCS_CS_REST_Wrapper_Base {
     ...
     * @access public
     */
    function VCS_CS_REST_Templates (
    $template_id,
    $auth_details,
    $protocol = 'https',
     ...
     *         )
     * @access public
     * @return VCS_CS_REST_Wrapper_Result A successful response will be the ID of the newly created template
     */
