 ...
 *
 */
if ( ! class_exists('VCS_CS_REST_General') ) :
class VCS_CS_REST_General extends VCS_CS_REST_Wrapper_Base {
     ...
     *
     * @return VCS_CS_REST_Wrapper_Result A successful response will be an array of the form:
