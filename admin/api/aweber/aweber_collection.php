<?php
class VCS_AWeberCollection extends VCS_AWeberResponse implements ArrayAccess, Iterator, Countable {
     ...
     * create
     *
     * Invoke the API method to CREATE a new VCS_entry resource.
     *
     ...
     * @return AWeberEntry(Resource) The new VCS_resource created
     */
    ...
    public function offsetGet($offset) {
        ...
        return new VCS_AWeberEntry($entry, $entry_url, $this->adapter);
    }
