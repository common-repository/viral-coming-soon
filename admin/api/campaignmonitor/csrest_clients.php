 ...
 *
 */
if ( ! class_exists('VCS_CS_REST_Clients') ) :
class VCS_CS_REST_Clients extends VCS_CS_REST_Wrapper_Base {
     ...
     *         )
     * @access public
     * @return VCS_CS_REST_Wrapper_Result A successful response will be the ID of the newly created client
     */
     ...
     *     )
     * @access public
     * @return VCS_CS_REST_Wrapper_Result A successful response will be an object
     * of the form:
     * {
     ...
     * @return VCS_CS_REST_Wrapper_Result a successful response will be an array in the form:
