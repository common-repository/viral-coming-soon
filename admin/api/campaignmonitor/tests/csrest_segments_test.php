...
class VCS_CS_REST_ApiKeyTestSegments extends VCS_CS_REST_TestSegments {
    var $auth = array('api_key' => 'not a real api key');
}

class VCS_CS_REST_OAuthTestSegments extends VCS_CS_REST_TestSegments {
    var $auth = array(
        'access_token' => '7y872y3872i3eh',
        'refresh_token' => 'kjw8qjd9ow8jo');
}

abstract class VCS_CS_REST_TestSegments extends VCS_CS_REST_TestBase {
    ...
    function set_up_inner() {
        ...
        $this->wrapper = new VCS_CS_REST_Segments($this->segment_id, $this->auth, $this->protocol, $this->log_level,
