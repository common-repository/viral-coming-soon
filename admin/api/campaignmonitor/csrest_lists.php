...
define('VCS_CS_REST_CUSTOM_FIELD_TYPE_TEXT', 'Text');
define('VCS_CS_REST_CUSTOM_FIELD_TYPE_NUMBER', 'Number');
define('VCS_CS_REST_CUSTOM_FIELD_TYPE_MULTI_SELECTONE', 'MultiSelectOne');
define('VCS_CS_REST_CUSTOM_FIELD_TYPE_MULTI_SELECTMANY', 'MultiSelectMany');
define('VCS_CS_REST_CUSTOM_FIELD_TYPE_DATE', 'Date');
define('VCS_CS_REST_CUSTOM_FIELD_TYPE_COUNTRY', 'Country');
define('VCS_CS_REST_CUSTOM_FIELD_TYPE_USSTATE', 'USState');

define('VCS_CS_REST_LIST_WEBHOOK_SUBSCRIBE', 'Subscribe');
define('VCS_CS_REST_LIST_WEBHOOK_DEACTIVATE', 'Deactivate');
define('VCS_CS_REST_LIST_WEBHOOK_UPDATE', 'Update');
define('VCS_CS_REST_LIST_UNSUBSCRIBE_SETTING_ALL_CLIENT_LISTS', 'AllClientLists');
define('VCS_CS_REST_LIST_UNSUBSCRIBE_SETTING_ONLY_THIS_LIST', 'OnlyThisList');
 ...
 *
 */
if ( ! class_exists('VCS_CS_REST_Lists') ) :
class VCS_CS_REST_Lists extends VCS_CS_REST_Wrapper_Base {
    ...
    $transport = NULL) {
        ...
        $this->VCS_CS_REST_Wrapper_Base($auth_details, $protocol, $debug_level, $host, $log, $serialiser, $transport);
     ...
     *             VCS_CS_REST_LIST_UNSUBSCRIBE_SETTING_ALL_CLIENT_LISTS or
     *             VCS_CS_REST_LIST_UNSUBSCRIBE_SETTING_ONLY_THIS_LIST.
     *             See the documentation for details: http://www.campaignmonitor.com/api/lists/#creating_a_list
     *     )
     * @access public
     * @return VCS_CS_REST_Wrapper_Result A successful response will be the ID of the newly created list
     */
     ...
     *             is VCS_CS_REST_LIST_UNSUBSCRIBE_SETTING_ALL_CLIENT_LISTS,
     ...
     *     )
     * @access public
     * @return VCS_CS_REST_Wrapper_Result A successful response will be empty
     */
     ...
     *     )
     * @access public
     * @return VCS_CS_REST_Wrapper_Result A successful response will be the 
     ...
     * @access public
     * @return VCS_CS_REST_Wrapper_Result A successful response will be an object of the form
     * array(
     *     {
     ...
     *         be either VCS_CS_REST_LIST_UNSUBSCRIBE_SETTING_ALL_CLIENT_LISTS or
     *         VCS_CS_REST_LIST_UNSUBSCRIBE_SETTING_ONLY_THIS_LIST.
     * }
     */
    function get() {
     ...
     *     )
     * @access public
     * @return VCS_CS_REST_Wrapper_Result A successful response will be the ID of the newly created webhook
     */
