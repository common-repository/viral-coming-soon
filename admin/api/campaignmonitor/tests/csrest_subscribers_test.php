...
class VCS_CS_REST_ApiKeyTestSubscribers extends VCS_CS_REST_TestSubscribers {
    var $auth = array('api_key' => 'not a real api key');
}

class VCS_CS_REST_OAuthTestSubscribers extends VCS_CS_REST_TestSubscribers {
    var $auth = array(
        'access_token' => '7y872y3872i3eh',
        'refresh_token' => 'kjw8qjd9ow8jo');
}

abstract class VCS_CS_REST_TestSubscribers extends VCS_CS_REST_TestBase {
    var $list_id = 'not a real list id';
    var $list_base_route;

    function set_up_inner() {
        $this->list_base_route = $this->base_route.'subscribers/'.$this->list_id;
        $this->wrapper = new VCS_CS_REST_Subscribers($this->list_id, $this->auth, $this->protocol, $this->log_level,
