...
class VCS_CS_REST_TestResponseDeserialisation extends UnitTestCase {
    var $responses;
    var $deserialiser;
    ...
    function test_services_json_serializer() {
        $log = new MockVCS_CS_REST_Log($this);
        $this->deserialiser = new VCS_CS_REST_ServicesJsonSerialiser($log);
    ...
    function test_services_native_serializer() {
        if(function_exists('json_decode') && function_exists('json_encode')):
            $log = new MockVCS_CS_REST_Log($this);
            $this->deserialiser = new VCS_CS_REST_NativeJsonSerialiser($log);
            $this->do_test_response_deserialisation();
        endif;
    }
