...
class VCS_CS_REST_ApiKeyTestPeople extends VCS_CS_REST_TestPeople {
    var $auth = array('api_key' => 'not a real api key');
}

class VCS_CS_REST_OAuthTestPeople extends VCS_CS_REST_TestPeople {
    var $auth = array(
        'access_token' => '7y872y3872i3eh',
        'refresh_token' => 'kjw8qjd9ow8jo');
}

abstract class VCS_CS_REST_TestPeople extends VCS_CS_REST_TestBase {
    ...
    function set_up_inner() {
        ...
        $this->wrapper = new VCS_CS_REST_People($this->client_id, $this->auth, $this->protocol, $this->log_level,
