 ...
 * Responses will exist as one of the two VCS_AWeberResponse subclasses:
 *  - AWeberEntry - a single instance of an AWeber resource
 *  - AWeberCollection - a collection of AWeber resources
 * @uses VCS_AWeberAPIBase
 * @package 
 * @version $id$
 */
class VCS_AWeberResponse extends VCS_AWeberAPIBase {
     ...
     * __construct
     *
     * Creates a new VCS_AWeberRespones
     *
