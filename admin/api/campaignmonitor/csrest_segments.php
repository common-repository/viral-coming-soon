 ...
 *
 */
if ( ! class_exists('VCS_CS_REST_Segments') ) :
class VCS_CS_REST_Segments extends VCS_CS_REST_Wrapper_Base {
     ...
     *             )
     *         )
     * @return VCS_CS_REST_Wrapper_Result A successful response will be the ID of the newly created segment
     */
